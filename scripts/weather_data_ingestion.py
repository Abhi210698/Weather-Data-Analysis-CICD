...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": [f"s3://weather-data-detail/date={current_date}/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://weather-data-detail/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::381492167257:role/service-role/AmazonRedshift-CommandsAccessRole-20240519T235759",
        "dbtable": "public.weather_data",
        "connectionName": "Redshift connection - airlines data",
